...
class Point():
    ...
    def print_coord (self):
        print(f'O PONTO {self.name} ESTA LOCALIZADO EM ({self.x}, {self.y})')
...
class Line():
    ...
    def print_lenght (self):
        ...
        print(f'COMPRIMENTO DA LINHA {self.name} : {c:.2f}')
...
class Circle:
    ...
    def print_area(self):
        a = 3.14 * self.raio**2
        print(f'A ÁREA DO CÍRCULO {self.name} É: {a:.2f}')

    def print_perimeter(self):
        p = 2 * 3.14 * self.raio
        print(f'O PERÍMETRO DO CÍRCULO {self.name} É: {p:.2f}')

    def print_coord (self):
        print(f'O CIRCULO {self.name} ESTÁ LOCALIZADO EM: ({self.centro.x}, {self.centro.y})')
...
class Triangle():
    ...
    def print_perimeter(self):
        ...
        p = l1 + l2 + l3
        print(f'O PERÍMETRO DO TRIÂNGULO {self.name} É: {p:.2f}')

    def print_coord (self):
        print(f'O TRIANGULO {self.name} ESTÁ LOCALIZADO EM: [({self.ponto1.x}, {self.ponto1.y}), ({self.ponto2.x}, {self.ponto2.y}), ({self.ponto3.x}, {self.ponto3.y})]')
